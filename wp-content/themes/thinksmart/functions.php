<?php
/**
 * thinksmart functions and definitions
 *
...
if ( ! function_exists( 'thinksmart_setup' ) ) :
	/**
	 ...
	 */
	function thinksmart_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on thinksmart, use a find and replace
		 * to change 'thinksmart' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'thinksmart', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'thinksmart' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'thinksmart_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'thinksmart_setup' );
 ...
 */
function thinksmart_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'thinksmart_content_width', 640 );
}
add_action( 'after_setup_theme', 'thinksmart_content_width', 0 );
 ...
 */
function thinksmart_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'thinksmart' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'thinksmart' ),
...
add_action( 'widgets_init', 'thinksmart_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function thinksmart_scripts() {
...
add_action( 'wp_enqueue_scripts', 'thinksmart_scripts' );
